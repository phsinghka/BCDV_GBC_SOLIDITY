...
contract stuview{
    ...
    modifier isTeacher{
        require(msg.sender == teacher, "Only Teacher is allowed to enroll a student");
        _;
    }
    ...
    function addStudent(string memory name, uint class, uint enrollDate) public isTeacher{
