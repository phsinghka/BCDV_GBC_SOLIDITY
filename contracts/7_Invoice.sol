...
contract MyInvoice{
    ...
    function newInvoice(uint _customerId, uint _invoiceNum, uint _total) public{
    ...
    function acceptPayment() public  payable{
        require(myInvoice[msg.sender].status == false,"You already paid and your balances are clear");
        require(msg.value==myInvoice[msg.sender].total,"Your payment should be exactly as your balance");
